...
import { addSubTaskDescription } from "../../api/TaskAPI";
import { UserContext } from '../../../context/UserContext';
import { ConfigContext } from '../../../context/ConfigContext';

const SubTaskDescription = (props) => {
    ...
    const onUpdateDescription = async() =>{
        ...
        await addSubTaskDescription(config, 'Bearer '+user.accessToken,props.record.id,description);
        setIsEditing(false);
    };
  ...
  return (
    <div>
      ...
      >
        ...
        <b>Task Name</b> - {props.record.taskName} <br/>
